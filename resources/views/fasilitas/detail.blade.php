...
@section('content')
    <div class="container pt-5">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item"
                                href="{{ route('fasilitas.edit', ['fasilita' => $fasilitas->id]) }}">Edit</a></li>
        ...
        <div class="text-center mb-4">
            <h2 style="color: #170F49;"><b>Infrastruktur {{ $fasilitas->name }} Kelurahan Mengger</b></h2> <br>
            <img width="30%" class="ms-auto" src="{{ asset('/fasilitas_file' . "/$fasilitas->image") }}"
                alt="">
        </div>
        <div class="container mb-5 pb-5">
            <div class="text-start">
                ...
                <h5>Keterangan : {{ $fasilitas->deskripsi }}</h5>
            </div>
        </div>
    </div>
    <form id="verifikasiForm" action="{{ route('fasilitas.destroy', ['fasilita' => $fasilitas->id]) }}" class="d-none"
        method="POST">
        @csrf
        @method('delete')
    </form>
...
@section('script')
    <script type="text/javascript">
        $('.hapus-btn').on('click', function() {
            ...
            Swal.fire({
                title: 'Apa Anda Yakin Ingin Menghapus Fasilitas Ini ?',
