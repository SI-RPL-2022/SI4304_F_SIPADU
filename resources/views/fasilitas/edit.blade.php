...
@section('content')
    <div class="container pt-5">
        ...
        <form action="{{ route('fasilitas.update', ['fasilita' => $fasilitas->id]) }}" enctype="multipart/form-data"
            method="post">
            @csrf
            @method('put')
                            ...
                            <div class="col">
                                <div class="py-3 text-start px-4">
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="nama" value="{{ $fasilitas->name }}"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="text" name="buka" value="{{ $fasilitas->buka }}"
                                            class="form-control py-2 px-3 rounded-pill border-0"
                                            style="box-shadow: 0px 4px 14px rgba(0, 0, 0, 0.1);"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <textarea type="text" name="alamat" class="form-control py-2 px-3 border-0"
                                            style="box-shadow: 0px 4px 14px rgba(0, 0, 0, 0.1);" placeholder="Masukkan alamat" rows="10" required>{{ $fasilitas->alamat }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
